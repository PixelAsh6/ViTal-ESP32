 ...
 *******************************************************************************/
 ...
 #ifndef COMPONENTS_SAL_BSW_HAL_COM_H
 #define COMPONENTS_SAL_BSW_HAL_COM_H
 ...
 typedef struct
 {
	 ...
	 uint8_t u8UserdataDCMi;
	 uint8_t u8UserdataDCMii;
	 uint8_t u8UserdataBuzzer;
	 uint8_t u8UserdataServomotor;
 } COM_POST_struct;
